...
def load_class_names():
    with open("yolov5/data.yaml", "r") as f:
...
# Clear corrupted YOLOv5 cache before loading
cache_dir = os.path.expanduser("~/.cache/torch/hub")
if os.path.exists(cache_dir):
    print("YOLO cache exists, skipping delete")
...
def run_yolo_detection(image_path, detection_folder, filename):
    ...
    cv2.imwrite(save_path, results.ims[0])
